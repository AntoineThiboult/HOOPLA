...
% 	.x(10) = GWLFL1
%
% 	.U = Rï¿½servoir de surface (mm)
% 	.L = Rï¿½servoir de sol (mm)
% 	.CK1 = Rï¿½servoir de ruissellement overlandflow 1 (mm)
% 	.CK2 = Rï¿½servoir de ruissellement overlandflow 2 (mm)
% 	.CK1b = Rï¿½servoir de ruissellement interflow 1(mm)
% 	.CK2b = Rï¿½servoir de ruissellement interflow 2(mm)
% 	.GW = Rï¿½servoir souterrain (mm)
%
% FOLLOWING
